...
def myNetwork():
    ...
    sw1 = net.addSwitch('switch1')
    sw2 = net.addSwitch('switch2')
    # Adding hosts
    ...
    net.start()
    sw1.cmd('ovs-vsctl set-controller ' +  sw1.name + ' tcp:127.0.0.1:6633') #connetto lo switch1 al controller C0
    sw2.cmd('ovs-vsctl set-controller ' +  sw2.name + ' tcp:127.0.0.1:6653') #connetto lo switch2 al controller C1
    CLI(net)
    net.stop()
